      ...
      <TooltipProvider>
        <Tooltip open={!isAnimating}>
          <TooltipTrigger asChild>
            <motion.div
              className={cx(
                'absolute bg-background p-3 border rounded-xl flex flex-row items-center',
                {
...
export const Toolbar = ({
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <motion.div
        className="cursor-pointer absolute right-6 bottom-6 h-fit  border border-border rounded-xl shadow-xl bg-background text-secondary-foreground flex flex-col justify-end"
